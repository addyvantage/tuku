...
func snapshotFromIPC(raw ipc.TaskShellSnapshotResponse) Snapshot {
	...
	if raw.Brief != nil {
		out.Brief = &BriefSummary{
			...
			PromptTargets:           append([]string{}, raw.Brief.PromptTargets...),
			ValidatorCommands:       append([]string{}, raw.Brief.ValidatorCommands...),
			ConfidenceLevel:         raw.Brief.ConfidenceLevel,
			ConfidenceReason:        raw.Brief.ConfidenceReason,
			EstimatedTokenSavings:   raw.Brief.EstimatedTokenSavings,
			DispatchPromptTokens:    raw.Brief.DispatchPromptTokens,
			StructuredPromptTokens:  raw.Brief.StructuredPromptTokens,
			DefaultSerializer:       raw.Brief.DefaultSerializer,
			StructuredCheaper:       raw.Brief.StructuredCheaper,
		}
	}
	if raw.Run != nil {
		out.Run = &RunSummary{
